package com.ietunnel.riskservice.evaluationRiskEstimate.Utils;
...
public class toWord {
    ...
    public StringBuffer toWord(List<exportEvaluationRiskEstimateVo> list) throws IOException {
        //获取模板文档
        File templateFile = new File("/Users/apple/Documents/riskAssessment_0612/风险估测汇总表.docx");
...
//                 所以拿到第一列数据后求出每个评估指标名称的个数,拿到每个名称的个数之后，需要对其累加即可拿到改数组所占的最后一行的索引，最后调用mergeUtil对其合并。
        ...
        for (exportEvaluationRiskEstimateVo exportEvaluationRiskEstimateVo : list) {
            column1.add(exportEvaluationRiskEstimateVo.getTunnelDivisionWork());
        }
        ...
        try {
            ...
            // 文件输出位置
            FileOutputStream fos = new FileOutputStream("/Users/apple/Documents/riskAssessment_0612/aaaa.docx");
            word.write(fos);
            fos.close();
        } catch (Exception e) {
            e.printStackTrace();
        ...
        doc.loadFromFile("/Users/apple/Documents/riskAssessment_0612/aaaa.docx", FileFormat.Doc);
        doc.saveToFile("/Users/apple/Documents/riskAssessment_0612/风险估测汇总表.html", FileFormat.Html);

        StringBuffer sb = new StringBuffer();
        BufferedReader br = new BufferedReader(new FileReader("/Users/apple/Documents/riskAssessment_0612/风险估测汇总表.html"));
        String content = null;
